...
#define FSGP_BUFFER_SIZE_LW_POS FRAME_HEADER_SIZE + 24*WORD128_BYTE_SIZE + LOW_WORD_OFFSET //115
#define FSGP_QUEUE_SIZE_LW_POS FRAME_HEADER_SIZE + 26*WORD128_BYTE_SIZE + LOW_WORD_OFFSET //123

// Fields value
#define FSGP_ACKFRAME_AUX_DATA_POS128 6
#define FSGP_ACKFRAME_DATA_SIZE128 1

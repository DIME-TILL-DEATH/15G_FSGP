...
#define FSGP_ACKFRAME_CTRL_SIZE128 4

#define FSGP_ACKFRAME_SYNC_OFFSET128 7
#define FSGP_ACKFRAME_SYNC_SIZE128 4

#define FSGP_ACKFRAME_AUX_DATA_OFFSET128 11
#define FSGP_ACKFRAME_AUX_DATA_SIZE128 1

#define FSGP_ACKFRAME_SIGNAL_OFFSET128 12
